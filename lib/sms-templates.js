/**
 * SMS text formatters for all notification types.
 * Each formatter returns a plain text string suitable for SMS delivery.
 * Messages are truncated to 160 chars to avoid Twilio segment/length errors.
 */
...
function formatMonthlyReport({ stats, month, insights }) {
...
function formatBudgetAlert({ percentageUsed, budgetAmount, totalExpenses, accountName, anomalies }) {
...
function formatBudgetCoach({ stats, advice }) {
