import { DEFAULT_LOCALE, resolveLocale } from "./config.js";
import { GENERATED_LOCALES } from "./generated-locales.js";
import { GENERATED_NOTIFICATION_LOCALES } from "./generated-notification-locales.js";
import { PATCH_LOCALES } from "./patch-locales.js";
...
export const MESSAGES = {
  en: {
    ...
    dashboard: {
      ...
      welcomeSubtitle: "Start by adding your first bank account to track your finances, set budgets, and get insights.",
    ...
    transaction: {
      ...
      fileSizeLimit: "File size should be less than {maxSizeMB}MB",
    ...
    settings: {
      ...
      deleteProfileDescription: "Permanently delete your profile and all linked data. This action cannot be undone.",
      deleteProfile: "Delete my account",
      deletingProfile: "Deleting account...",
      profileDeleted: "Your account has been deleted.",
      failedDeleteProfile: "Failed to delete account",
      confirmDeleteProfile: "Delete your entire account and all data? This cannot be undone."
    },
    accountCard: {
    ...
    budget: {
      ...
      fiftyRuleStrip: "₹{amount} reserved for savings/investment (50% rule)",
      overBudget: "You've exceeded your spending budget! Consider reducing expenses."
    },
    account: {
      accountLabel: "Account",
    ...
    onboarding: {
      ...
      phoneDesc: "Add your phone number to receive SMS alerts and updates.",
  ...
  hi: {
    ...
    dashboard: {
      ...
      welcomeTitle: "Gullak में आपका स्वागत है!",
      welcomeSubtitle: "अपने खर्च ट्रैक करने, बजट सेट करने और इनसाइट्स पाने के लिए अपना पहला बैंक खाता जोड़ें।",
      addFirstAccount: "अपना पहला खाता जोड़ें"
    },
    reports: {
      title: "रिपोर्ट्स",
    ...
    transaction: {
      ...
      fileSizeLimit: "फाइल आकार {maxSizeMB}MB से कम होना चाहिए",
    ...
    settings: {
      ...
      languageTitle: "भाषा",
      languageDesc: "ऐप्लिकेशन के लिए अपनी पसंदीदा भाषा चुनें।",
      dangerZone: "खतरे का क्षेत्र",
      deleteProfileDescription: "अपना प्रोफ़ाइल और उससे जुड़ा पूरा डेटा स्थायी रूप से हटाएं। यह क्रिया पूर्ववत नहीं की जा सकती।",
      deleteProfile: "मेरा खाता हटाएं",
      deletingProfile: "खाता हटाया जा रहा है...",
      profileDeleted: "आपका खाता हटा दिया गया है।",
      failedDeleteProfile: "खाता हटाने में विफल",
      confirmDeleteProfile: "क्या आप अपना पूरा खाता और सारा डेटा हटाना चाहते हैं? यह पूर्ववत नहीं होगा।"
    },
    accountCard: {
    ...
    budget: {
      ...
      fiftyRuleStrip: "₹{amount} बचत/निवेश के लिए आरक्षित (50% नियम)",
      overBudget: "आपने अपना खर्च बजट पार कर लिया है! खर्च कम करने पर विचार करें।"
    },
    account: {
      accountLabel: "खाता",
    ...
    onboarding: {
      ...
      budget: "बजट",
      welcomeTitle: "Gullak में आपका स्वागत है! 🎉",
      welcomeDesc: "कुछ आसान चरणों में अपनी प्रोफ़ाइल सेट करें। भाषा चुनें, बैंक खाता जोड़ें और मासिक बजट सेट करें।",
      getStarted: "शुरू करें",
      addAccountTitle: "अपना बैंक खाता जोड़ें",
      addAccountDesc: "अपने मुख्य बैंक खाते की जानकारी दर्ज करें।",
      chooseLanguage: "अपनी भाषा चुनें",
      languageDesc: "ऐप के लिए अपनी पसंदीदा भाषा चुनें।",
      phoneTitle: "फोन नंबर जोड़ें",
      phoneDesc: "SMS अलर्ट और अपडेट पाने के लिए अपना फोन नंबर जोड़ें।",
      phoneLabel: "फोन नंबर",
      phoneRequired: "आगे बढ़ने के लिए फोन नंबर आवश्यक है।",
      phoneFormat: "देश कोड के साथ अंतर्राष्ट्रीय फ़ॉर्मेट (जैसे भारत के लिए +91)",
      saving: "सहेजा जा रहा है...",
      back: "वापस",
      continue: "जारी रखें",
      setBudgetTitle: "अपना मासिक बजट सेट करें",
      setBudgetDesc: "इस महीने आप कितना खर्च करने की योजना बना रहे हैं?",
...
const MODULE_SECTION_KEYS = ["sidebar", "dashboard", "reports", "transaction", "settings", "accountCard", "budget", "transactionTable", "analytics", "recurring", "goals", "createAccountDrawer", "phoneBanner", "onboarding", "categories", "account", "accountAnalytics", "accountChart"];
...
Object.entries(GENERATED_NOTIFICATION_LOCALES).forEach(([localeCode, generated]) => {
  if (!MESSAGES[localeCode]) return;
  MESSAGES[localeCode] = mergeNested(MESSAGES[localeCode], generated);
});
...
export const translate = (locale, key, values = {}, fallback) => {
  ...
  const shouldPreferHindiFallback =
  ...
  const secondaryFallbackMessages =
    shouldPreferHindiFallback && MESSAGES.hi ? MESSAGES.hi : fallbackMessages;

  const currentValue = getValueByPath(currentMessages, key);
  const secondaryValue = getValueByPath(secondaryFallbackMessages, key);
  const englishValue = getValueByPath(fallbackMessages, key);
...
Object.assign(MESSAGES.en, {
  goals: {
    title: 'Goals',
    subtitle: 'Plan your targets, build your savings pots, and achieve your financial dreams.',
    totalLocked: 'Total Money Saved',
    activeGoals: 'Active Goals',
    nextGoalToHit: 'Next Goal to Hit',
    createGoal: 'Create Goal',
    createGoalDesc: 'Name your target, set an amount, and start saving.',
    goalName: 'Goal Name',
    ...
    noGoalsSub: 'You havent set any financial goals yet. Whats your next big target? A laptop? A vacation? Let\'s start tracking!',
    addFundsTitle: 'Add Funds to Goal',
    amountToAdd: 'Amount to Add',
    amountToAddDesc: 'Enter the amount you are putting towards this goal today.',
    cancel: 'Cancel',
    save: 'Save Funds',
    adding: 'Adding...',
    achieved: 'Achieved!',
    ...
    failedAction: 'Failed to process request.'
  }
});
if (MESSAGES.hi) {
  Object.assign(MESSAGES.hi, {
    goals: {
      title: 'लक्ष्य',
      subtitle: 'अपने लक्ष्यों की योजना बनाएं, अपनी बचत राशि जमा करें और अपने सपनों को पूरा करें।',
      totalLocked: 'कुल बचत राशि',
      activeGoals: 'सक्रिय लक्ष्य',
      nextGoalToHit: 'अगला लक्ष्य',
      createGoal: 'लक्ष्य बनाएं',
      createGoalDesc: 'अपना लक्ष्य चुनें, राशि तय करें और बचत शुरू करें।',
      goalName: 'लक्ष्य का नाम',
      targetAmount: 'लक्ष्य राशि',
      targetDate: 'लक्ष्य की तारीख (वैकल्पिक)',
      color: 'रंग',
      addFunds: 'पैसे जोड़ें',
      noGoals: 'कोई सक्रिय लक्ष्य नहीं।',
      noGoalsSub: 'आपने अभी तक कोई वित्तीय लक्ष्य निर्धारित नहीं किया है। अगला बड़ा लक्ष्य क्या है?',
      addFundsTitle: 'लक्ष्य में पैसे जोड़ें',
      amountToAdd: 'पैसे दर्ज करें',
      amountToAddDesc: 'वह राशि दर्ज करें जो आप आज जमा कर रहे हैं।',
      cancel: 'रद्द करें',
      save: 'सेव करें',
      adding: 'जोड़ा जा रहा है...',
      achieved: 'पूरा हुआ!',
      inProgress: 'प्रगति पर',
      deletedSuccess: 'लक्ष्य सफलतापूर्वक हटाया गया।',
      failedAction: 'प्रक्रिया विफल रही।'
    }
  });
}

Object.assign(MESSAGES.en.goals || {}, {
  createdSuccess: "Goal created successfully!",
  goalNamePlaceholder: "e.g. New Macbook",
  targetAmountPlaceholder: "100000",
  selectThemeColor: "Select a theme color for this goal"
});

if (MESSAGES.hi?.goals) {
  Object.assign(MESSAGES.hi.goals, {
    createdSuccess: "लक्ष्य सफलतापूर्वक बनाया गया!",
    goalNamePlaceholder: "जैसे नया लैपटॉप",
    targetAmountPlaceholder: "100000",
    selectThemeColor: "इस लक्ष्य के लिए एक रंग चुनें"
  });
}

Object.assign(MESSAGES.en.analytics || {}, {
  storyStart: "Your financial story starts here. Log your first expense or income to unlock AI-driven insights!"
});

if (MESSAGES.hi?.analytics) {
  Object.assign(MESSAGES.hi.analytics, {
    storyStart: "आपकी वित्तीय कहानी यहां से शुरू होती है। AI इनसाइट्स पाने के लिए अपनी पहली आय या खर्च दर्ज करें!"
  });
}

if (MESSAGES.hi?.dashboard) {
  Object.assign(MESSAGES.hi.dashboard, {
    insightBudgetRiskTitle: "बजट जोखिम बढ़ा हुआ है",
    insightBudgetRiskDetail: "इस महीने की आय का {pct}% पहले ही खर्च हो चुका है।",
    insightCashflowHealthyTitle: "कैशफ्लो अभी स्वस्थ है",
    insightCashflowHealthyDetail: "प्रोजेक्शन से पहले इस महीने आप {amount} बचा रहे हैं।",
    insightCategoryConcentrationTitle: "श्रेणी एकाग्रता पाई गई",
    insightCategoryConcentrationDetail: "इस महीने के खर्चों में {topCategory} की हिस्सेदारी {pct}% है।",
    insightSpendingMixBalancedTitle: "खर्च का मिश्रण संतुलित है",
    insightSpendingMixBalancedDetail: "शीर्ष श्रेणी ({topCategory}) कुल खर्च का {pct}% योगदान देती है।",
    insightUnusualExpenseMovementTitle: "असामान्य खर्च गतिविधि",
    insightUnusualExpenseMovementDetail: "हाल की {count} ट्रांज़ैक्शन सामान्य खर्च पैटर्न से बाहर हैं।",
    insightNoAnomalySignalTitle: "इस महीने कोई असामान्यता संकेत नहीं",
    insightNoAnomalySignalDetail: "हाल का खर्च पैटर्न आपकी सामान्य सीमा में है।",
    insightSpendingAcceleratedTitle: "खर्च में तेजी आई है",
    insightSpendingAcceleratedDetail: "पिछले महीने की तुलना में खर्च {pct}% बढ़ा है।",
    insightGreatMomentumTitle: "पिछले महीने की तुलना में शानदार प्रगति",
    insightGreatMomentumDetail: "पिछले महीने की तुलना में खर्च {pct}% घटा है।",
    insightMoMSteadyTitle: "महीना-दर-महीना खर्च स्थिर है",
    insightMoMSteadyDetail: "पिछले महीने की तुलना में अंतर {variance}% है।"
  });
}

if (!MESSAGES.en.notifications) MESSAGES.en.notifications = {};
Object.assign(MESSAGES.en.notifications, {
  txSub: "New Transaction Logged - Gullak",
  txAlertMessage: "A new transaction has been recorded in your account.",
  adviceExpenseSpendCap: "You spent ₹{amount} on {category}. Keep {category} spend under ₹{sevenDayCap} over the next 7 days.",
  adviceIncomeSaveNow: "Income of ₹{amount} recorded. Move at least ₹{saveNow} to savings within 24 hours.",
  adviceLowBalanceDailyLimit: "Current balance is ₹{newBalance}. Keep daily non-essential spend under ₹{dailyLimit} for the next 7 days.",
  adviceReserveProtect: "Balance is ₹{newBalance}. Protect at least ₹{reserve} as a reserve before discretionary spending.",
  adviceFrequentExpenseAudit: "You logged {recentExpenseCount} recent expense entries. Audit subscriptions today and cut 1 recurring charge this week.",
  adviceSteadyExpenseReview: "Recent expense frequency is {recentExpenseCount} entries. Keep this pace and do a 10-minute spend review every Sunday.",
  adviceBudgetWeeklyCap: "For the next {weeksLeft} week(s), keep total spending below ₹{weeklyCap} per week (about ₹{dailyCap}/day).",
  adviceBudgetBuffer: "Maintain a safety buffer of at least ₹{bufferTarget}; pause non-essential purchases whenever balance nears this level.",
  adviceBudgetPause: "Apply a 24-hour pause to any non-essential spend above ₹{nonEssentialThreshold} to reduce impulse purchases.",
  monthlyInsightCashflow: "{month}: expenses were ₹{totalExpenses} against income ₹{totalIncome}. Keep next month's savings rate above {savingsRateTarget}%.",
  monthlyInsightTopCategory: "{topCategory} is your top spend at ₹{topCategoryAmount} ({topCategoryShare}% of expenses). Set a weekly cap of ₹{topCategoryWeeklyCap} for this category.",
  monthlyInsightWeeklyCeiling: "Set a weekly total expense ceiling of ₹{weeklyExpenseCap}. Review spending every Sunday and trim the largest category by at least 10%.",
  coachAdviceSubscriptions: "Check your recurring subscriptions.",
  coachAdviceCook: "Try cooking at home more often.",
  coachAdviceHabits: "Review your daily spending habits.",
  coachAdviceCap: "For the next 7 days, keep discretionary spending under ₹{discretionaryCap}.",
  coachAdviceMove: "Move ₹{savingsMove} to a savings bucket before mid-week to reduce overspending pressure.",
  coachAdviceReview: "Review top 3 expenses every Sunday and cut the largest one by at least 10% next week.",
  accountSub: "Account Created - Gullak",
  accountAlertMessage: "Your account {accountName} was created successfully.",
  budgetSetSub: "Budget Set - Financial Advice",
  budgetSetAlertMessage: "Your monthly budget is set. Review your balance and follow the tips below.",
  currentBalanceDesc: "Current balance: {balance}",
  monthlyAlertMessage: "Here is your monthly financial summary for {month}.",
  monthlyDesc: "Income: {totalIncome}, Net: {net}",
  budgetAnomalyAlertMessage: "We detected unusual spending patterns in your account. Please review recent transactions.",
  budgetUsageAlertMessage: "You have used {percentageUsed}% of your monthly budget.",
  budgetAmountDesc: "Budget amount: {budgetAmount}",
  coachAlertMessage: "Your weekly budget digest is ready with actionable tips.",
  weeklyDigestCategory: "Weekly Budget Digest",
  remainingBudgetDesc: "Remaining monthly budget: {remainingBudget}",
  welcomeAlertMessage: "Your account is ready. Start tracking expenses, setting budgets, and receiving smart insights.",
  welcomeAlertDescription: "Complete onboarding to unlock the full Gullak experience."
});

if (MESSAGES.hi) {
  if (!MESSAGES.hi.notifications) MESSAGES.hi.notifications = {};
  Object.assign(MESSAGES.hi.notifications, {
    txSub: "नई ट्रांज़ैक्शन दर्ज हुई - Gullak",
    txAlertMessage: "आपके खाते में एक नई ट्रांज़ैक्शन दर्ज की गई है।",
    adviceExpenseSpendCap: "आपने {category} पर ₹{amount} खर्च किए। अगले 7 दिनों में {category} का खर्च ₹{sevenDayCap} से कम रखें।",
    adviceIncomeSaveNow: "₹{amount} की आय दर्ज हुई। अगले 24 घंटों में कम से कम ₹{saveNow} बचत में डालें।",
    adviceLowBalanceDailyLimit: "वर्तमान बैलेंस ₹{newBalance} है। अगले 7 दिनों तक दैनिक गैर-जरूरी खर्च ₹{dailyLimit} से कम रखें।",
    adviceReserveProtect: "बैलेंस ₹{newBalance} है। वैकल्पिक खर्च से पहले कम से कम ₹{reserve} को रिजर्व रखें।",
    adviceFrequentExpenseAudit: "हाल ही में {recentExpenseCount} खर्च एंट्री दर्ज हुई हैं। आज सब्सक्रिप्शन जांचें और इस हफ्ते 1 आवर्ती खर्च कम करें।",
    adviceSteadyExpenseReview: "हाल की खर्च आवृत्ति {recentExpenseCount} एंट्री है। इसी गति को बनाए रखें और हर रविवार 10 मिनट खर्च समीक्षा करें।",
    adviceBudgetWeeklyCap: "अगले {weeksLeft} सप्ताह तक कुल खर्च ₹{weeklyCap} प्रति सप्ताह (लगभग ₹{dailyCap}/दिन) से नीचे रखें।",
    adviceBudgetBuffer: "कम से कम ₹{bufferTarget} का सुरक्षा बफर रखें; बैलेंस इस स्तर के पास आए तो गैर-जरूरी खरीद रोकें।",
    adviceBudgetPause: "₹{nonEssentialThreshold} से ऊपर के गैर-जरूरी खर्च पर 24 घंटे का विराम रखें ताकि आवेगपूर्ण खरीद कम हो।",
    monthlyInsightCashflow: "{month}: आय ₹{totalIncome} के मुकाबले खर्च ₹{totalExpenses} रहा। अगले महीने बचत दर {savingsRateTarget}% से ऊपर रखें।",
    monthlyInsightTopCategory: "{topCategory} में सबसे ज्यादा खर्च ₹{topCategoryAmount} रहा ({topCategoryShare}% कुल खर्च)। इस श्रेणी के लिए साप्ताहिक सीमा ₹{topCategoryWeeklyCap} रखें।",
    monthlyInsightWeeklyCeiling: "साप्ताहिक कुल खर्च सीमा ₹{weeklyExpenseCap} रखें। हर रविवार समीक्षा करें और सबसे बड़ी श्रेणी में कम से कम 10% कटौती करें।",
    coachAdviceSubscriptions: "अपने आवर्ती सब्सक्रिप्शन की जांच करें।",
    coachAdviceCook: "घर पर खाना अधिक बार बनाने की कोशिश करें।",
    coachAdviceHabits: "अपने दैनिक खर्च की आदतों की समीक्षा करें।",
    coachAdviceCap: "अगले 7 दिनों तक गैर-जरूरी खर्च ₹{discretionaryCap} से नीचे रखें।",
    coachAdviceMove: "मध्य-सप्ताह से पहले ₹{savingsMove} को बचत में ट्रांसफर करें ताकि अधिक खर्च का दबाव कम हो।",
    coachAdviceReview: "हर रविवार शीर्ष 3 खर्च देखें और अगले हफ्ते सबसे बड़े खर्च को कम से कम 10% घटाएं।",
    accountSub: "खाता बनाया गया - Gullak",
    accountAlertMessage: "आपका खाता {accountName} सफलतापूर्वक बनाया गया।",
    budgetSetSub: "बजट सेट हुआ - वित्तीय सलाह",
    budgetSetAlertMessage: "आपका मासिक बजट सेट हो गया है। अपना बैलेंस देखें और नीचे दी गई सलाह अपनाएं।",
    currentBalanceDesc: "वर्तमान बैलेंस: {balance}",
    monthlyAlertMessage: "यह {month} के लिए आपकी मासिक वित्तीय सारांश रिपोर्ट है।",
    monthlyDesc: "आय: {totalIncome}, शेष: {net}",
    budgetAnomalyAlertMessage: "आपके खाते में असामान्य खर्च पैटर्न मिला है। हाल की ट्रांज़ैक्शन की समीक्षा करें।",
    budgetUsageAlertMessage: "आपने अपने मासिक बजट का {percentageUsed}% उपयोग कर लिया है।",
    budgetAmountDesc: "बजट राशि: {budgetAmount}",
    coachAlertMessage: "आपका साप्ताहिक बजट सारांश उपयोगी सुझावों के साथ तैयार है।",
    weeklyDigestCategory: "साप्ताहिक बजट सारांश",
    remainingBudgetDesc: "शेष मासिक बजट: {remainingBudget}",
    welcomeAlertMessage: "आपका खाता तैयार है। खर्च ट्रैक करें, बजट सेट करें और स्मार्ट इनसाइट्स पाएं।",
    welcomeAlertDescription: "पूरा अनुभव पाने के लिए ऑनबोर्डिंग पूरा करें।"
  });
}

if (!MESSAGES.en.emails) MESSAGES.en.emails = {};
Object.assign(MESSAGES.en.emails, {
  helloUser: "Hello {userName},",
  monthlyReportPreview: "Your Monthly Financial Report",
  monthlyReportTitle: "Monthly Financial Report",
  monthlyReportIntro: "Here is your financial summary for {month}:",
  totalIncome: "Total Income",
  totalExpenses: "Total Expenses",
  net: "Net",
  expensesByCategory: "Expenses by Category",
  gullakInsights: "Gullak Insights",
  monthlyFooter: "Thank you for using Gullak. Keep tracking your finances for better financial health!",
  budgetAlertPreview: "Budget Alert",
  budgetAlertTitle: "Budget Alert",
  budgetAlertIntro: "You have used {percentageUsed}% of your monthly budget.",
  budgetAmount: "Budget Amount",
  spentSoFar: "Spent So Far",
  remaining: "Remaining",
  welcomeIntro: "We are excited to have you on board! Gullak helps you track your expenses, set budgets, and achieve your financial goals with the help of AI.",
  gettingStarted: "Getting Started",
  welcomeStep1: "1. Set up your accounts to track balances.",
  welcomeStep2: "2. Add your transactions regularly.",
  welcomeStep3: "3. Create a monthly budget to stay on track.",
  welcomeFooter: "If you have any questions, feel free to reply to this email.",
  accountCreatedPreview: "New Account Created",
  accountCreatedTitle: "New Account Added",
  accountCreatedIntro: "You have successfully created a new account:",
  initialBalance: "Initial Balance",
  type: "Type",
  transactionLoggedPreview: "Transaction Logged",
  transactionLoggedTitle: "Transaction Logged",
  transactionLoggedIntro: "A new transaction has been successfully logged.",
  amount: "Amount",
  detailedDescription: "Detailed Description",
  category: "Category",
  smartSpendingTips: "Smart Spending Tips",
  budgetCoachPreview: "Your Weekly Budget Coach",
  budgetCoachTitle: "Weekly Budget Coach",
  budgetCoachIntro: "Here is your weekly financial advice to keep you on track!",
  lastWeekSnapshot: "Last Week's Snapshot",
  totalSpent: "Total Spent",
  remainingMonthlyBudget: "Remaining Monthly Budget",
  smartAdvice: "Smart Advice",
  budgetCreatedPreview: "Budget Set and AI Advice",
  budgetCreatedTitle: "Budget Set Successfully",
  budgetCreatedIntro: "You have successfully set your monthly budget.",
  monthlyBudget: "Monthly Budget",
...
if (MESSAGES.hi) {
  if (!MESSAGES.hi.emails) MESSAGES.hi.emails = {};
  Object.assign(MESSAGES.hi.emails, {
    helloUser: "नमस्ते {userName},",
    monthlyReportPreview: "आपकी मासिक वित्तीय रिपोर्ट",
    monthlyReportTitle: "मासिक वित्तीय रिपोर्ट",
    monthlyReportIntro: "यह {month} के लिए आपका वित्तीय सारांश है:",
    totalIncome: "कुल आय",
    totalExpenses: "कुल खर्च",
    net: "शेष",
    expensesByCategory: "श्रेणी अनुसार खर्च",
    gullakInsights: "Gullak इनसाइट्स",
    monthlyFooter: "Gullak उपयोग करने के लिए धन्यवाद। बेहतर वित्तीय स्वास्थ्य के लिए ट्रैकिंग जारी रखें!",
    budgetAlertPreview: "बजट अलर्ट",
    ...
    remaining: "शेष",
    welcomeIntro: "हम आपको अपने साथ पाकर खुश हैं! Gullak आपको खर्च ट्रैक करने, बजट सेट करने और AI की मदद से वित्तीय लक्ष्य हासिल करने में मदद करता है।",
    gettingStarted: "शुरुआत करें",
    welcomeStep1: "1. बैलेंस ट्रैक करने के लिए खाते सेट करें।",
    welcomeStep2: "2. अपनी ट्रांज़ैक्शन नियमित रूप से जोड़ें।",
    welcomeStep3: "3. ट्रैक पर रहने के लिए मासिक बजट बनाएं।",
    welcomeFooter: "यदि कोई प्रश्न हो तो इस ईमेल का उत्तर दें।",
    accountCreatedPreview: "नया खाता बना",
    accountCreatedTitle: "नया खाता जोड़ा गया",
    accountCreatedIntro: "आपने सफलतापूर्वक नया खाता बनाया है:",
    initialBalance: "प्रारंभिक बैलेंस",
    type: "प्रकार",
    transactionLoggedPreview: "ट्रांज़ैक्शन दर्ज हुई",
    transactionLoggedTitle: "ट्रांज़ैक्शन दर्ज हुई",
    transactionLoggedIntro: "एक नई ट्रांज़ैक्शन सफलतापूर्वक दर्ज की गई है।",
    amount: "राशि",
    detailedDescription: "विवरण",
    category: "श्रेणी",
    smartSpendingTips: "स्मार्ट खर्च सुझाव",
    budgetCoachPreview: "आपका साप्ताहिक बजट कोच",
    budgetCoachTitle: "साप्ताहिक बजट कोच",
    budgetCoachIntro: "ट्रैक पर रहने के लिए यह साप्ताहिक वित्तीय सलाह देखें!",
    lastWeekSnapshot: "पिछले सप्ताह का सारांश",
    totalSpent: "कुल खर्च",
    remainingMonthlyBudget: "शेष मासिक बजट",
    smartAdvice: "स्मार्ट सलाह",
    budgetCreatedPreview: "बजट सेट और AI सलाह",
    budgetCreatedTitle: "बजट सफलतापूर्वक सेट हुआ",
    budgetCreatedIntro: "आपने अपना मासिक बजट सफलतापूर्वक सेट किया है।",
    monthlyBudget: "मासिक बजट",
    currentAccountBalance: "वर्तमान खाता बैलेंस",
    aiFinancialAdvice: "AI वित्तीय सलाह"
  });
}

if (!MESSAGES.en.common) MESSAGES.en.common = {};
Object.assign(MESSAGES.en.common, {
  none: "None"
});

if (MESSAGES.hi) {
  if (!MESSAGES.hi.common) MESSAGES.hi.common = {};
  Object.assign(MESSAGES.hi.common, {
    none: "कोई नहीं"
  });
}
...
if (MESSAGES.hi) {
  Object.assign(MESSAGES.hi, {
    errors: {
      ...
      cannotDeleteDefault: 'डिफ़ॉल्ट खाते को नहीं हटाया जा सकता। कृपया पहले किसी अन्य खाते को डिफ़ॉल्ट सेट करें।',
...
Object.assign(MESSAGES.en.notifications, {
    ...
    transactionSuccessCompact: 'Gullak: ₹{amount} logged in {category}.',
...
if (MESSAGES.hi) {
  ...
  Object.assign(MESSAGES.hi.notifications, {
      ...
      transactionSuccess: 'Gullak: \"{description}\" ({category}) के लिए ₹{amount} की ट्रांज़ैक्शन दर्ज हुई।',
      transactionSuccessCompact: 'Gullak: {category} में ₹{amount} की ट्रांज़ैक्शन दर्ज हुई।',
...
if (MESSAGES.kn) {
  if (!MESSAGES.kn.notifications) MESSAGES.kn.notifications = {};
  Object.assign(MESSAGES.kn.notifications, {
    txSub: "ಹೊಸ ವಹಿವಾಟು ದಾಖಲಿಸಲಾಗಿದೆ - Gullak",
    txAlertMessage: "ನಿಮ್ಮ ಖಾತೆಯಲ್ಲಿ ಹೊಸ ವಹಿವಾಟು ದಾಖಲಾಗಿದೆ.",
    transactionSuccessCompact: "Gullak: {category} ನಲ್ಲಿ ₹{amount} ದಾಖಲಾಗಿದೆ.",
    monthlySub: "ನಿಮ್ಮ ಮಾಸಿಕ ಹಣಕಾಸು ವರದಿ - {month}",
    budgetSub: "ಬಜೆಟ್ ಎಚ್ಚರಿಕೆ: {accountName}",
    coachSub: "ವಾರದ ಬಜೆಟ್ ಡೈಜೆಸ್ಟ್ - Gullak",
    welcomeSub: "Gullak ಗೆ ಸ್ವಾಗತ"
  });

  if (!MESSAGES.kn.emails) MESSAGES.kn.emails = {};
  Object.assign(MESSAGES.kn.emails, {
    helloUser: "ನಮಸ್ಕಾರ {userName},",
    transactionLoggedPreview: "ವಹಿವಾಟು ದಾಖಲಾಗಿದೆ",
    transactionLoggedTitle: "ವಹಿವಾಟು ದಾಖಲಾಗಿದೆ",
    transactionLoggedIntro: "ಹೊಸ ವಹಿವಾಟು ಯಶಸ್ವಿಯಾಗಿ ದಾಖಲಾಗಿದೆ.",
    amount: "ಮೊತ್ತ",
    detailedDescription: "ವಿವರ",
    category: "ವರ್ಗ",
    smartSpendingTips: "ಸ್ಮಾರ್ಟ್ ಖರ್ಚು ಸಲಹೆಗಳು",
    monthlyFooter: "Gullak ಬಳಸಿದಕ್ಕಾಗಿ ಧನ್ಯವಾದಗಳು. ಉತ್ತಮ ಹಣಕಾಸು ಆರೋಗ್ಯಕ್ಕಾಗಿ ಟ್ರ್ಯಾಕಿಂಗ್ ಮುಂದುವರಿಸಿ!"
  });
}

const notificationFallbackBase = MESSAGES.hi?.notifications || MESSAGES.en?.notifications || {};
const emailFallbackBase = MESSAGES.hi?.emails || MESSAGES.en?.emails || {};

Object.keys(MESSAGES).forEach((localeCode) => {
  if (localeCode === DEFAULT_LOCALE) return;
  if (!MESSAGES[localeCode]) return;

  const existingNotifications = MESSAGES[localeCode].notifications || {};
  const existingEmails = MESSAGES[localeCode].emails || {};

  MESSAGES[localeCode].notifications = mergeNested(notificationFallbackBase, existingNotifications);
  MESSAGES[localeCode].emails = mergeNested(emailFallbackBase, existingEmails);
});

// ── Error pages, 404, budget validation, goal-card, transfer labels ──
if (!MESSAGES.en.errorPage) MESSAGES.en.errorPage = {};
Object.assign(MESSAGES.en.errorPage, {
...
if (!MESSAGES.en.notFound) MESSAGES.en.notFound = {};
Object.assign(MESSAGES.en.notFound, {
  description: "Oops! The page you're looking for seems to have wandered off. Let's get you back to your finances.",
  returnDashboard: "Return to Dashboard"
});
...
if (!MESSAGES.en.budgetValidation) MESSAGES.en.budgetValidation = {};
Object.assign(MESSAGES.en.budgetValidation, {
  exceedsFiftyPercent: "Budget cannot exceed 50% of your account balance (₹{maxAmount})",
  fiftyRuleDescription: "Gullak ensures you budget safely! Your spending is capped at 50% of your total balance. The remaining balance will be untouched for your savings and investments."
});

Object.assign(MESSAGES.en.goals, {
  pacingProjection: "At your current savings rate, projected to hit target by {date}",
  pacingBoost: "Boost your monthly savings to unlock AI completion projections.",
  confirmDelete: "Are you sure you want to delete this goal?",
  targetLabel: "Target: ₹{amount}",
  targetByDate: "by {date}",
  savedAmount: "₹{amount} saved",
  goalAchieved: "🎯 Goal Achieved! Congratulations on hitting your target.",
  addedFundsSuccess: "Successfully added ₹{amount} to {name}",
  failedAddFunds: "Failed to add funds"
});

if (!MESSAGES.en.recurring) MESSAGES.en.recurring = {};
Object.assign(MESSAGES.en.recurring, {
  emptyMotivation: "No subscriptions tracked yet. Add your Netflix or gym memberships so you never face a surprise charge!"
});

if (!MESSAGES.en.transaction) MESSAGES.en.transaction = {};
Object.assign(MESSAGES.en.transaction, {
  transfer: "Transfer",
  fromAccount: "From Account",
  toAccount: "To Account",
  selectDestAccount: "Select destination account",
  scanInvalid: "Scanned data was incomplete. Please fill the fields manually.",
  scanFailed: "Could not read the selected file. Please try again."
});

Object.assign(MESSAGES.en.settings, {
  budgetLabel: "Budget:",
  budgetAmtPlaceholder: "Amt"
});

// ── Hindi translations for the new keys ──
if (MESSAGES.hi) {
  if (!MESSAGES.hi.errorPage) MESSAGES.hi.errorPage = {};
  Object.assign(MESSAGES.hi.errorPage, {
    title: "कुछ गलत हो गया",
    description: "एक अनपेक्षित त्रुटि हुई। कृपया पेज को रीलोड करें।",
    tryAgain: "फिर से प्रयास करें",
    returnDashboard: "डैशबोर्ड पर लौटें"
  });

  if (!MESSAGES.hi.notFound) MESSAGES.hi.notFound = {};
  Object.assign(MESSAGES.hi.notFound, {
    description: "ओह! जो पेज आप ढूंढ रहे हैं वह मिल नहीं रहा। चलिए वापस चलते हैं।",
    returnDashboard: "डैशबोर्ड पर लौटें"
  });
  ...
  if (!MESSAGES.hi.budgetValidation) MESSAGES.hi.budgetValidation = {};
  Object.assign(MESSAGES.hi.budgetValidation, {
    exceedsFiftyPercent: "बजट आपके खाते की शेष राशि के 50% से अधिक नहीं हो सकता (₹{maxAmount})",
    fiftyRuleDescription: "Gullak सुनिश्चित करता है कि आपका बजट सुरक्षित रहे! आपका खर्च आपकी कुल शेष राशि के 50% तक सीमित है। बाकी राशि बचत और निवेश के लिए सुरक्षित रहेगी।"
  });

  Object.assign(MESSAGES.hi.goals, {
    pacingProjection: "आपकी वर्तमान बचत दर पर, {date} तक लक्ष्य पूरा होने का अनुमान है",
    pacingBoost: "AI अनुमान देखने के लिए अपनी मासिक बचत बढ़ाएं।",
    confirmDelete: "क्या आप वाकई इस लक्ष्य को हटाना चाहते हैं?",
    targetLabel: "लक्ष्य: ₹{amount}",
    targetByDate: "{date} तक",
    savedAmount: "₹{amount} बचाया",
    goalAchieved: "🎯 लक्ष्य पूरा हुआ! बधाई हो!",
    addedFundsSuccess: "₹{amount} सफलतापूर्वक {name} में जोड़ा गया",
    failedAddFunds: "पैसे जोड़ने में विफल"
  });

  if (!MESSAGES.hi.recurring) MESSAGES.hi.recurring = {};
  Object.assign(MESSAGES.hi.recurring, {
    emptyMotivation: "अभी तक कोई सब्सक्रिप्शन ट्रैक नहीं है। अपने Netflix या जिम की मेम्बरशिप जोड़ें!"
  });

  if (!MESSAGES.hi.transaction) MESSAGES.hi.transaction = {};
  Object.assign(MESSAGES.hi.transaction, {
    transfer: "ट्रांसफ़र",
    fromAccount: "किस खाते से",
    toAccount: "किस खाते में",
    selectDestAccount: "गंतव्य खाता चुनें",
    scanInvalid: "स्कैन किया गया डेटा अधूरा था। कृपया मैन्युअली भरें।",
    scanFailed: "फ़ाइल पढ़ नहीं सकी। कृपया फिर से प्रयास करें।"
  });

  Object.assign(MESSAGES.hi.settings || {}, {
    budgetLabel: "बजट:",
    budgetAmtPlaceholder: "राशि"
  });
}

Object.entries(PATCH_LOCALES).forEach(([localeCode, patch]) => {
  if (!MESSAGES[localeCode]) return;
  MESSAGES[localeCode] = mergeNested(MESSAGES[localeCode], patch);
});
