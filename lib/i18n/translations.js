...
export const MESSAGES = {
  en: {
    ...
    onboarding: {
      ...
      welcomeDesc: "Let's set up your profile in just a few steps. Add a bank account, choose your language, and set a monthly budget.",
...
export const translate = (locale, key, values = {}, fallback) => {
  ...
  if (resolved === "onboarding.addAccountTitle") resolved = "Add Your Bank Account";
  if (resolved === "onboarding.addAccountDesc") resolved = "Enter the details of your primary bank account.";
