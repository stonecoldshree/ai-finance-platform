...
if (!MESSAGES.en.goals) MESSAGES.en.goals = {};
...
if (MESSAGES.hi) {
  if (!MESSAGES.hi.goals) MESSAGES.hi.goals = {};
...
const notificationFallbackBase = MESSAGES.en?.notifications || {};
const emailFallbackBase = MESSAGES.en?.emails || {};
