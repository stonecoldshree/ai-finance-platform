  ...
  if (topCategoryShare >= 35) {
    insights.push({
      ...
      detail: translate(
        ...
        `${topCategory} accounts for ${topCategoryShare.toFixed(1)}% of this month's expenses.`,
        { topCategory, pct: topCategoryShare.toFixed(1) }
      )
    });
  } else {
    insights.push({
      ...
      detail: translate(
        ...
        `Top category (${topCategory}) contributes ${topCategoryShare.toFixed(1)}% of expenses.`,
        { topCategory, pct: topCategoryShare.toFixed(1) }
      )
    });
  }
